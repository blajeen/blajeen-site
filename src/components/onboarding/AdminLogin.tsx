...
export function AdminLogin() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    router.push('/admin/onboardings');
  }
  return (
    <div className="mx-auto max-w-lg px-[var(--gutter)] py-24">
      <p className="tecnica text-signal">ÁREA INTERNA</p>
      <h1 className="mt-5 text-[clamp(2.5rem,7vw,4.5rem)] leading-none">Onboardings.</h1>
      <p className="mt-5 text-mineral">Acesso reservado à equipe da Blajeen Labs.</p>
