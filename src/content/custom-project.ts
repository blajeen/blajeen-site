...
export const projetoPersonalizado = {
  ...
  descricao:
    'Coloque seu projeto — ou até uma ideia ainda no começo — em prática com a Blajeen Labs. Da criação da identidade ao desenvolvimento do site, aplicativo ou sistema, cuidamos de cada etapa para construir uma solução com a sua cara e as funcionalidades que você realmente precisa.',
  complemento:
